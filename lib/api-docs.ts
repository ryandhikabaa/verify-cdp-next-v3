...
export const endpointDocs: EndpointDocDefinition[] = [
  ...
  },
  {
    ...
    requestExample: JSON.stringify({
      ...
      checksum_valid: true,
      qr_value: 'V3QR-ASTRA-3R9K221',
      qr_format: 'QR_CODE',
      qr_detected: true,
      qr_bounds: {x: 120, y: 80, width: 220, height: 220},
    ...
    responseContract: JSON.stringify({
      request: {
        ...
        qr_value: 'string (optional)',
        qr_format: 'string (optional)',
        qr_detected: 'boolean (optional)',
        qr_bounds: 'object (optional)',
        payload_mode: '"encrypted" | "legacy" | "three-part" (optional)',
