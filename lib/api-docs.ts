...
export const endpointDocs: EndpointDocDefinition[] = [
  ...
  },
  {
    ...
    description: 'Melakukan upsert satu data pattern berdasarkan serial.',
  ...
  {
    id: 'patterns-next-index',
    group: 'Patterns',
    method: 'GET',
    path: '/api/patterns/next-index',
    access: 'Public',
    summary: 'Mengambil nomor urut berikutnya untuk prefix pattern.',
    description: 'Gunakan query `prefix` untuk mengambil index berikutnya dari serial tertentu.',
    queryExample: {prefix: 'VERIFY'},
    responseExample: JSON.stringify({status: true, message: 'Next pattern index retrieved', data: {nextIndex: 24}}, null, 2),
  },
  {
    id: 'patterns-delete',
    group: 'Patterns',
    ...
    access: 'Admin',
    summary: 'Menghapus satu pattern berdasarkan serial.',
    description: 'Menghapus satu record pattern berdasarkan parameter path `id`.',
